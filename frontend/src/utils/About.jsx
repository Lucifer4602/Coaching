...
export const About = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-blue-400 to-purple-500 min-h-screen">
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-b from-blue-500 to-purple-600 animate-gradient-xy"></div>
      </div>
      <Navbar />
      ...
      <div className="flex flex-col items-center justify-center py-16 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-white">
            Discover a world of learning opportunities tailored just for you.
          </p>
        </motion.div>
